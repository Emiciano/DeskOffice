...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-30 h-screen w-64 rounded-none rounded-r-2xl border-y-0 border-l-0 border-r border-border/80 bg-card p-4 shadow-soft backdrop-blur-sm">
